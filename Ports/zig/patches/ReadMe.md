...
## `0005-clang-Add-fvisibility-inlines-hidden-function-templa.patch`

Add -fvisibility-inlines-hidden-function-templates


## `0006-Extend-support-for-SerenityOS-target.patch`

Extend support for SerenityOS target


## `0007-Implement-SerenityOS-support-in-std.patch`

Implement SerenityOS support in std


## `0008-build-Adjust-build-process-for-SerenityOS.patch`

build: Adjust build process for SerenityOS


## `0009-zlib-Fix-implicit-write-method-declaration-error.patch`

zlib: Fix implicit write() method declaration error


## `0010-build-Remove-unsupported-zig-linker-flag-z-seperate-.patch`

build: Remove unsupported zig linker flag -z seperate-code


## `0011-doctest-Filter-ZIG_LIBC-from-the-environment.patch`
...
## `0012-build-Set-Zig-version-to-0.14.0-dev.839-a931bfada.patch`

build: Set Zig version to 0.14.0-dev.839+a931bfada
